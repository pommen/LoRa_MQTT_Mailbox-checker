...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "cG9tbWVuc2lvdEBnbWFpbC5jb20="; //pommensIOT@gmail.com
        const char* EMAILBASE64_PASSWORD = "TWl0dGFuZHJhTWFpbGtvbnRv"; //MittandraMailkonto
        const char* FROM = "pommensIOT@gmail.com";
